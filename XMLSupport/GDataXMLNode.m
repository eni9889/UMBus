...
-(NSComparisonResult)compareUsingName:(GDataXMLElement*)inPerson
{
	NSString*	selfCommaName = [[[(GDataXMLElement*)self elementsForName:@"name2"] objectAtIndex:0] stringValue];
	NSString*	otherPersonCommaName = [[[inPerson elementsForName:@"name2"] objectAtIndex:0] stringValue];
